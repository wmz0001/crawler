...
class Future:
    ...
    def add_done_callback(self, fn):  # Add a callback to be run when the future becomes done.
    ...
    def _process_response(self):
        ...
        for url in urls:
            ...
            if defragmented not in urls_seen:
                ...
                Task(Fetcher(defragmented).fetch())  # this can return quickly and save the io time
